...
class LELabelledCell: UITableViewCell {
    ...
    public func configureCell(_ title: String, _ titleColor: UIColor) {
        versionsLabel.text = title
        versionsLabel.textColor = titleColor
